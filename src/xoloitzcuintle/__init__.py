...
def derechos():             #Burocracia
    if os.name == "posix":
        print(chr(27)+"[1;33m"+'Asquel 0.0.0.0e para '+platform.system()) #[version mayor].[version menor].[compilacion].[prueba]
        ...
        print("Asquel 0.0.0.0e para Windows")
